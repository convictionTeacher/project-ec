...
class getCustomerControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.D_RNAgX'] ?? $container->load('get_ServiceLocator_DRNAgXService'))->withContext('Eccube\\Controller\\Admin\\Customer\\CustomerController', $container));
